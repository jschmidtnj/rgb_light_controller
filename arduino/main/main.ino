...
const String host = "https://us-central1-rgb-light-controller.cloudfunctions.net/getrgbsettings";
const unsigned int numsecdelay = 5;
const char* fingerprint = "5B FE C9 1D 0A 3A 26 51 BD 0F 55 45 33 21 F4 54 AD 87 E5 4C"; //or thumbprint on windows. get from dev console on chrome in security
